...
#new connectal
[ -d connectal ] || git clone https://github.com/cambridgehackers/connectal.git connectal
cd connectal;
#git reset --hard 62a9af99ed464ee88c99292f661cc9f31a3a5371
git pull
cd ../;

[ -d fpgamake ] || git clone https://github.com/cambridgehackers/fpgamake.git
cd fpgamake;
...
[ -d buildcache ] || git clone https://github.com/cambridgehackers/buildcache.git
cd buildcache;
